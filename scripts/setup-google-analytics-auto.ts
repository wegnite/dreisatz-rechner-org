...
详细步骤请查看: scripts/ga-setup-sop.md
  ...
  async run() {
    ...
    try {
      ...
      if (existingProperty) {
        this.spinner.succeed(`找到现有媒体资源: ${existingProperty.displayName}`);
      ...
      console.log(chalk.white('2. 确认你的 layout.tsx 或 _app.tsx 包含 GA 代码:'));
...
<Script id="google-analytics" strategy="afterInteractive">
  ...
  \`}
      ...
      console.log(chalk.white('4. 访问 GA 界面验证数据: https://analytics.google.com/\n'));
